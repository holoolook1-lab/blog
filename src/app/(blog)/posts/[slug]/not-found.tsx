...
export default function PostNotFound() {
  return (
    <main id="main" className="max-w-3xl mx-auto p-6 space-y-4" role="main" aria-labelledby="post-notfound-title">
      <div className="flex items-center justify-between">
        <h1 id="post-notfound-title" className="text-2xl font-bold">글을 찾을 수 없습니다</h1>
