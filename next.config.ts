...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      (isDevelopment || isVercel) ? "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://storage.googleapis.com" : "script-src 'self' blob: https://storage.googleapis.com",
      ...
      (isDevelopment || isVercel) ? "script-src-elem 'self' 'unsafe-inline' https://storage.googleapis.com" : "script-src-elem 'self' https://storage.googleapis.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
    ].join('; ');
